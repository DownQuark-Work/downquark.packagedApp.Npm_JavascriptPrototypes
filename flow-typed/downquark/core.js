...
declare class String {
    ...
    constructor(value?: mixed): void;
    endsWith:(searchString: string, position?: number)=> boolean | ((searchString: string, position?: number)=> boolean);
    ...
    padStart:(targetLength: number, padString?: string) => string | ((targetLength: number, padString?: string) => string);
...
declare var console: {
    ...
    dev:(...data: Array<any>) => string|false,
    devCount:number,
    ...
    IN_DEVELOPMENT:{_global:boolean, _groupByDefault:boolean, base:boolean, contactPage:boolean,},
